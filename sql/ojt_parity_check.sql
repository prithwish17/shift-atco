...
INSERT INTO ojt_parity_expected VALUES
  ...
  ('PARITY-10021023', 'ADC', '2027-01-21'::date, 163, 90, 'WATCH', false),
  ('PARITY-10024032', 'ADC', '2026-10-31'::date, 81, 31.5, 'ON_TRACK', false),
  ('PARITY-10021723', 'ADC', '2026-10-07'::date, 57, 90, 'CRITICAL', false),
  ...
  ('PARITY-10021025', 'OCC', '2026-08-25'::date, 14, 45, 'CRITICAL', true),
  ('PARITY-10021111', 'ADC', '2026-11-12'::date, 93, 77.25, 'WATCH', false),
  ('PARITY-10022052', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ('PARITY-10023447', 'PLR', '2026-09-03'::date, 23, 60, 'CRITICAL', false),
  ...
  ('PARITY-10023424', 'PLR', '2026-09-04'::date, 24, 60, 'CRITICAL', false),
  ('PARITY-10023109', 'PLR', '2026-04-17'::date, -116, 60, 'DEADLINE_PASSED', false),
  ('PARITY-10002979', 'OCC', '2026-02-10'::date, -182, 45, 'DEADLINE_PASSED', false),
  ('PARITY-10020170', 'ACC+ACC(S)', '2026-12-08'::date, 119, 0, 'HOURS_COMPLETE', false),
  ('PARITY-10022059', 'ADC', '2026-02-17'::date, -175, 90, 'DEADLINE_PASSED', false),
  ...
  ('PARITY-10015621', 'ACC+ACC(S)', '2026-07-06'::date, -36, 10, 'DEADLINE_PASSED', false),
  ('PARITY-10023669', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ('PARITY-10023608', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ('PARITY-10015589', 'OCC', '2026-05-23'::date, -80, 45, 'DEADLINE_PASSED', false),
  ('PARITY-10005102', 'ADC', '2026-12-09'::date, 120, 61, 'WATCH', false),
  ('PARITY-10020257', 'OCC', '2026-05-23'::date, -80, 45, 'DEADLINE_PASSED', false),
  ...
  ('PARITY-10020143', 'APP+APP(S)', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ...
  ('PARITY-10015614', 'OCC', '2026-06-02'::date, -70, 45, 'DEADLINE_PASSED', false),
  ...
  ('PARITY-10023483', 'PLR', '2026-09-06'::date, 26, 60, 'CRITICAL', false),
  ('PARITY-10002911', 'ACC+ACC(S)', '2026-08-16'::date, 5, 30, 'CRITICAL', true),
  ('PARITY-10023398', 'PLR', '2026-09-03'::date, 23, 60, 'CRITICAL', false),
  ...
  ('PARITY-10003864', 'OCC', '2026-08-25'::date, 14, 45, 'CRITICAL', true),
  ('PARITY-10003218', 'APP+APP(S)', '2026-02-27'::date, -165, 0, 'HOURS_COMPLETE', false),
  ('PARITY-10023364', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ...
  ('PARITY-10023395', 'PLR', '2026-09-03'::date, 23, 60, 'CRITICAL', false),
  ('PARITY-10002317', 'ACC+ACC(S)', '2027-03-11'::date, 212, 39.5, 'ON_TRACK', false),
  ('PARITY-10023526', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ...
  ('PARITY-10023379', 'PLR', '2026-09-03'::date, 23, 60, 'CRITICAL', false),
  ...
  ('PARITY-10023639', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ('PARITY-10003134', 'APP+APP(S)', '2026-04-19'::date, -114, 0, 'HOURS_COMPLETE', false),
  ('PARITY-10003134', 'ADC', '2026-10-28'::date, 78, 60, 'WATCH', false),
  ('PARITY-10023236', 'PLR', '2026-05-14'::date, -89, 0, 'HOURS_COMPLETE', false),
  ('PARITY-10023348', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ...
  ('PARITY-10022080', 'ADC', '2026-09-30'::date, 50, 90, 'CRITICAL', false),
  ...
  ('PARITY-10021915', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ('PARITY-10023586', 'ADC', '2027-01-28'::date, 170, 87, 'WATCH', false),
  ('PARITY-10023432', 'PLR', '2026-09-05'::date, 25, 60, 'CRITICAL', false),
  ...
  ('PARITY-10012601', 'OCC', '2025-11-17'::date, -267, 45, 'DEADLINE_PASSED', false),
  ...
  ('PARITY-10023538', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ('PARITY-10023690', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ...
  ('PARITY-10023250', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ('PARITY-10013564', 'OCC', '2026-09-10'::date, 30, 0, 'HOURS_COMPLETE', false),
  ('PARITY-10023567', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
  ('PARITY-10009953', 'ADC', '2026-12-11'::date, 122, 75, 'WATCH', false),
  ('PARITY-10023430', 'PLR', '2026-09-03'::date, 23, 60, 'CRITICAL', false),
  ('PARITY-10023503', 'PLR', '2026-11-29'::date, 110, 60, 'WATCH', false),
