...
INSERT INTO public.sync_jobs (job_name, edge_function_name, cron_schedule, payload) VALUES
  ...
  -- Night roster: IST 13–23 → UTC 07:30–17:30
  ...
  ('roster-night-19h', 'sync-roster', '30 13 * * *', '{"shift":"Night"}'),
  ('roster-night-20h', 'sync-roster', '30 14 * * *', '{"shift":"Night"}'),
  ('roster-night-21h', 'sync-roster', '30 15 * * *', '{"shift":"Night"}'),
  ('roster-night-22h', 'sync-roster', '30 16 * * *', '{"shift":"Night"}'),
  ('roster-night-23h', 'sync-roster', '30 17 * * *', '{"shift":"Night"}')
