...
Deno.serve(async (req) => {
    ...
    const jobName =
        ...
        (typeof requestBody?.__cron_job_name === "string" ? requestBody.__cron_job_name : "fetch-el-data");
    ...
    try {
        ...
        await logApiCall("success", successMsg, durationMs, triggeredBy, upsertedDetails);
