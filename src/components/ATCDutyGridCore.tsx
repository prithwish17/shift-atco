...
export function ATCDutyGridCore({
    ...
    // Search filter (optional) — debounced to prevent rapid re-renders
    const filteredSections = useMemo(() => {
        if (!showSearch || !debouncedSearch.trim()) return sections;
    ...
    }, [sections, showSearch, debouncedSearch, assignmentMap]);
