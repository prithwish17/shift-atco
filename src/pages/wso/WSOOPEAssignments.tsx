...
export default function WSOOPEAssignments() {
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Employees assigned extra or overtime duties</p>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card className="bg-violet-50/70 border-violet-100 dark:bg-violet-950/30 dark:border-violet-900/40">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">Total OPE Employees</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">Duty Types</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardContent className="py-12 text-center">
              <p className="text-muted-foreground">
                No extra duty assignments for {format(selectedDate, "dd MMM yyyy")}
              </p>
            </CardContent>
          </Card>
        ) : (
