...
import { ChevronLeft, ChevronRight, FileDown, Filter, Loader2, Pencil, RefreshCcw, Search } from "lucide-react";
...
export default function SupervisorAttendanceView() {
  ...
  const thumbWidth = gridScrollMetrics.trackWidth > 0 ? Math.min(gridScrollMetrics.trackWidth, Math.max(92, rawThumbWidth)) : 0;
          ...
          <div className="flex-1 flex flex-col overflow-hidden min-h-0">
            ...
            <div className="shrink-0 flex border-t border-slate-300 bg-slate-100/90">
              ...
              <div className="flex-1 px-3 py-2">
                <div ref={horizontalTrackRef} onMouseDown={handleHorizontalTrackMouseDown} className="relative h-6 rounded-full bg-slate-300/90 shadow-inner">
                  <div
