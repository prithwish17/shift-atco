...
export default function EmployeeProfile() {
  ...
  const traineeMilestone = useMemo(() => extractTraineeMilestone(trainingRecord), [trainingRecord]);
          ...
          <CardContent className="p-3 sm:p-6 lg:p-7">
            <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
              <div className="space-y-5">
                ...
                <div className="flex flex-col items-center gap-3 md:flex-row md:items-center sm:gap-4">
            ...
            <CardContent>
              <Tabs defaultValue="personal" className="space-y-5">
                ...
                <TabsContent value="license" className="space-y-4">
                  ...
                  {traineeMilestone && (
                    <SectionCard title="Trainee Progress" description="Training unit marking and milestone schedule linked to your employee record.">
                      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                        <div className="rounded-2xl bg-slate-50 px-4 py-3 dark:bg-slate-900">
                          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-700 dark:text-slate-300">Marked Unit</p>
                          <p className="mt-1 text-base font-semibold">{traineeMilestone.unit || "Not marked"}</p>
                        </div>
                        <div className="rounded-2xl bg-slate-50 px-4 py-3 dark:bg-slate-900">
                          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-700 dark:text-slate-300">Total Hours</p>
                          <p className="mt-1 text-base font-semibold">{traineeMilestone.hours_required ?? "—"}</p>
                        </div>
                        <div className="rounded-2xl bg-slate-50 px-4 py-3 dark:bg-slate-900">
                          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-700 dark:text-slate-300">Status</p>
                          <div className="mt-2 flex flex-wrap gap-2">
                            <Badge className={cn("rounded-full border px-2.5 py-1 text-[11px] font-medium", getTraineeStatusBadgeClass(traineeMilestone.status))}>
                              {getTraineeStatusLabel(traineeMilestone.status)}
                            </Badge>
                            {scheduledTraineeMilestone && (
                              <Badge className={cn("rounded-full border px-2.5 py-1 text-[11px] font-medium", scheduledTraineeMilestone.countdownClass)}>
                      ...
                      <div className="mt-4 grid gap-3 md:grid-cols-3">
                        <div className="rounded-2xl border border-slate-200/80 p-3 dark:border-slate-800">
                          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-700 dark:text-slate-300">Pre-Board Completed</p>
                          <p className="mt-1 text-sm font-semibold">{formatTraineeDate(traineeMilestone.preboard_completed_on)}</p>
                        </div>
                        <div className="rounded-2xl border border-slate-200/80 p-3 dark:border-slate-800">
                          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-700 dark:text-slate-300">Pre-Board Scheduled</p>
                          <p className="mt-1 text-sm font-semibold">{formatTraineeDate(traineeMilestone.preboard_scheduled_on)}</p>
                        </div>
                        <div className="rounded-2xl border border-slate-200/80 p-3 dark:border-slate-800">
                          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-700 dark:text-slate-300">Board Scheduled</p>
                          <p className="mt-1 text-sm font-semibold">{formatTraineeDate(traineeMilestone.board_scheduled_on)}</p>
                        </div>
                      </div>
                    </SectionCard>
                  )}
